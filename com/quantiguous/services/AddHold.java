 ...
 *         &lt;element ref="{http://www.quantiguous.com/services}dpType"/>
 *         &lt;element ref="{http://www.quantiguous.com/services}issueType"/>
...
@XmlRootElement(name = "addHold")
public class AddHold {
